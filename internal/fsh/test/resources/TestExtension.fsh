...
// context defined using context keyword
Context: $COMBINATION#extension[required], $COMBINATION#extension[optional], "(Condition | Observation).code"

// context defined in caret value rules
* ^context[+].type = #element
* ^context[=].expression = "SomeExpression"

// marking as modifier extension
* . 0..1 ?!
* . ^isModifierReason = "Example modifier reason."
